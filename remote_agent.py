...
# ✅ Serve HTML directly using Tailwind
    ...
    <html>
        ...
        <body class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 to-white">
            <form action="/execute" method="post" class="bg-white p-8 rounded-xl shadow-md w-full max-w-lg space-y-6">
                ...
                <input name="query" placeholder="What is the weather in Mumbai today?" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-200"/>
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg">Get Weather</button>
            </form>
        </body>
    </html>
    """

# ✅ Weather query POST handler
